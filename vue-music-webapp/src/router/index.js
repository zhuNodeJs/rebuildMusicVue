...
const MySongListDetail = resolve =>
  require(["@/components/MySongListDetail/MySongListDetail"], resolve);
const MyRecommend = resolve =>
  require(["@/components/MyRecommend/MyRecommend"], resolve);
const MySinger = resolve =>
  require(["@/components/MySinger/MySinger"], resolve);
const MyRank = resolve => require(["@/components/MyRank/MyRank"], resolve);
const MySearch = resolve =>
  require(["@/components/MySearch/MySearch"], resolve);
const MySingerDetail = resolve =>
  require(["@/components/MySingerDetail/MySingerDetail"], resolve);
const MyRankDetail = resolve =>
  require(["@/components/MyRankDetail/MyRankDetail"], resolve);
